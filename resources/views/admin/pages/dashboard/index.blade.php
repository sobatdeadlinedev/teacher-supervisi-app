            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="#" class="btn btn-flex btn-primary h-40px fs-7 fw-bold" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_create_campaign">New
                        Campaign</a>
                </div>
                <!--end::Actions-->
            </div>
                                    ...
                                    <div class="d-flex flex-wrap flex-md-nowrap">
                                            ...
                                            <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                                ...
                                                <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        <span class="text-gray-500 fw-bold d-block fs-7">Great,
                                            ...
                                            <div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
                                                ...
                                                <div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
                                                    ...
                                                    <div class="me-2">
                                                        ...
                                                        <span class="text-gray-500 fw-bold d-block fs-7">You
                                        ...
                                        <div
                                            ...
                                            <div class="mx-auto">
                                                ...
                                                <div class="d-flex align-items-center mb-2">
                                                    <!--begin::Bullet-->
                                                    <div class="bullet bullet-dot w-8px h-7px bg-info me-2">
                                                    </div>
                                                    <!--end::Bullet-->
                                                    <!--begin::Label-->
                                                    <div class="fs-8 fw-semibold text-muted">
                            ...
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end">
                                    <a href="#kt_sliders_widget_3_slider"
                                        ...
                                        data-bs-slide="prev">
                                        <i class="ki-outline ki-left-square fs-2x text-gray-500"></i>
                                    </a>
                                    <a href="#kt_sliders_widget_3_slider"
                                        class="carousel-control-next position-relative me-1" role="button"
                                        data-bs-slide="next">
                                        <i class="ki-outline ki-right-square fs-2x text-gray-500"></i>
                                    </a>
                                </div>
                            </div>
                            <!--end::Toolbar-->
