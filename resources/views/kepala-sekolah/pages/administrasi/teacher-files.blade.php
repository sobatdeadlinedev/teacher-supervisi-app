            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">
                        File Administrasi - {{ $teacher->name }}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ $teacher->name }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('kepala-sekolah.administrasi.index') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body pt-0">
                    @if ($files->isEmpty())
                        ...
                        <div class="text-center py-15">
                            ...
                            <p class="text-gray-600 mb-6">Guru ini belum mengupload file administrasi</p>
                        </div>
                        <!--end::Empty state-->
                    @else
                        <!--begin::Table-->
